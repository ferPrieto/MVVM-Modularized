    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            return listOf(
                ...
                arrayOf(Names("NameReallyReallyReallySuperLong", "SomeLastName"), false),
                arrayOf(Names("", "LastNameReallyReallyLongLongg"), false),
                arrayOf(Names("SomeName", "SomeLastName"), true),
                arrayOf(Names("Six", "The"), true),
                arrayOf(Names("NameReallyReallySuperLong", "LastNameReallyReallyLongLongg"), false),
                arrayOf(Names("NameReallyReallySuperLong", "LastNameReallyReallyLong"), true)
