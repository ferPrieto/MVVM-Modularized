...
class DashboardViewModelTest {
    ...
    private lateinit var randomJokeRetrievedTestObserver: Observer<prieto.fernando.model.RandomJokeAndTitleResource>
    private lateinit var customRandomJokeRetrievedTestObserver: Observer<prieto.fernando.model.RandomJokeAndTitleResource>
    ...
    fun `When randomJoke then randomJokeRetrieved invoked with expected result`() {
        ...
        val expected = prieto.fernando.model.RandomJokeAndTitleResource(
            randomJokeUiModel,
            stringResource
        )
        ...
        // Then
        val captor =
            ArgumentCaptor.forClass(prieto.fernando.model.RandomJokeAndTitleResource::class.java)
        captor.run {
